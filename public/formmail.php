...
$DEF_ALERT = "roewenstrunk@edirom.de";
...
$CSVDIR    = "/var/opt/nfdi"; /* directory for csv files; empty string to disallow csv files */
...
$TEMPLATEDIR = "/var/www/html/formTemplates"; /* directory for template files; empty string if you don't have any templates */
